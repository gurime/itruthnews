...
if (!article) return { title: 'iTruth News | Page Not Found' };
...
{/* --- PROTECTED CONTENT --- */}
{/* We wrap the Article Body in ArticleAccess. 
...
{/* Tags Section (Inside access control so it hides on paywall, optional) */}
{data.tags && (
<div className="mb-8">
...
{/* Author Card (Visible to everyone) */}
{data.author && (
