...
<Link href="/headlines" className="block px-2 py-1 hover:bg-blue-600 rounded">Global Headlines</Link>
<Link href="/internaional" className="block px-2 py-1 hover:bg-blue-600 rounded">International Politics</Link>
...
<Link href="/globalhealth" className="block px-2 py-1 hover:bg-blue-600 rounded">Global Health</Link>
...
<Link href="/us" className="block px-2 py-1 hover:bg-blue-600 rounded">U.S.</Link>
...
<Link href="/tech/peripherals" className="block px-2 py-1 hover:bg-blue-600 rounded">Peripherals</Link>
<Link href="/tech/monitors" className="block px-2 py-1 hover:bg-blue-600 rounded">Monitors</Link>
</div>
...
<Link href="/tech/apple" className="block px-2 py-1 hover:bg-blue-600 rounded">Apple </Link>
<Link href="/tech/microsoft" className="block px-2 py-1 hover:bg-blue-600 rounded">Microsoft</Link>
<Link href="/tech/google" className="block px-2 py-1 hover:bg-blue-600 rounded">Google</Link>
<Link href="/tech/samsung" className="block px-2 py-1 hover:bg-blue-600 rounded">Samsung</Link>
<Link href="/tech/lenovo" className="block px-2 py-1 hover:bg-blue-600 rounded">Lenovo</Link>
<Link href="/tech/acer" className="block px-2 py-1 hover:bg-blue-600 rounded">Acer</Link>
<Link href="/tech/asus" className="block px-2 py-1 hover:bg-blue-600 rounded">Asus</Link>
<Link href="/tech/msi" className="block px-2 py-1 hover:bg-blue-600 rounded">MSI</Link>
<Link href="/tech/dell" className="block px-2 py-1 hover:bg-blue-600 rounded">Dell</Link>
<Link href="/tech/hp" className="block px-2 py-1 hover:bg-blue-600 rounded">HP</Link>
</div>
...
<Link href="/videogames/playstation" className="block px-2 py-1 hover:bg-blue-600 rounded">PlayStation</Link>
<Link href="/videogames/xbox" className="block px-2 py-1 hover:bg-blue-600 rounded">Xbox </Link>
<Link href="/videogames/nintendo" className="block px-2 py-1 hover:bg-blue-600 rounded">Nintendo</Link>
<Link href="/videogames/pc" className="block px-2 py-1 hover:bg-blue-600 rounded">PC</Link>
<Link href="/videogames/mobile" className="block px-2 py-1 hover:bg-blue-600 rounded">Mobile</Link>
<Link href="/videogames/cloud" className="block px-2 py-1 hover:bg-blue-600 rounded">Cloud</Link>
...
<Link href="/healinesports" className="block px-2 py-1 hover:bg-blue-600 rounded">Headline Sports</Link>
...
<button
type="button"
className="w-full font-semibold text-left hover:underline cursor-pointer flex items-center justify-between "
...
<Link href="/tech/wearables" className="block px-2 py-1 hover:bg-blue-600 rounded">Wearables</Link>
<Link href="/tech/smart-home" className="block px-2 py-1 hover:bg-blue-600 rounded">Smart Home</Link>
<Link href="/tech/gadgets" className="block px-2 py-1 hover:bg-blue-600 rounded">Gadgets</Link>
</div>
</div>
)}
</div>
