...
{activeDropdown === 'news' && (
<div ref={dropdownRef} className="absolute left-0 bg-blue-900 text-white mt-2 py-4 w-96 rounded shadow-lg z-50">
...
<div ref={dropdownRef} className="absolute left-0 bg-blue-900 text-white mt-2 py-4 w-64 rounded shadow-lg z-50">
...
<div ref={dropdownRef} className="absolute left-0 bg-blue-900 text-white mt-2 py-4 w-80 rounded shadow-lg z-50 max-h-[600px] overflow-y-auto">
