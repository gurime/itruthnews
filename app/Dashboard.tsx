  ...
  useEffect(() => {
    async function fetchArticles() {
      try {
        ...
        // Fetch articles from main article table
...
className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadowcursor-pointer block relative">
